...
combined_avg = pd.concat([H3K4me1, H3K27me3, H3K9ac, H3K27ac, H3K27me3, fpkm_log], axis=1)

#combined_avg.columns = sys.argv[1:6]


model = smf.ols(formula='fpkm_log ~ H3K4me1 + H3K4me3 + H3K4me3 + H3K27ac + H3K27me3', data=combined_avg)
results = model.fit()
